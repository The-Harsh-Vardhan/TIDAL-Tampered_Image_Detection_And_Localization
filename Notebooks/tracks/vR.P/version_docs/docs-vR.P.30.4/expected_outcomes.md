# vR.P.30.4 -- Expected Outcomes

## Metric Targets

| Metric | Expected Range | Success Threshold |
|--------|---------------|-------------------|
| Pixel F1 | 0.77-0.79 | > 0.7379 (+0.5pp over P.15) |
...
1. P.12 showed augmentation was neutral/negative with ELA. Hypothesis: CBAM spatial attention makes model robust to geometric transforms.
