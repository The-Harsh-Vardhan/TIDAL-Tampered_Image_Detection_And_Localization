# vR.P.30.2 -- Expected Outcomes

## Metric Targets

| Metric | Expected Range | Success Threshold |
|--------|---------------|-------------------|
| Pixel F1 | 0.77-0.80 | > 0.7379 (+0.5pp over P.15) |
...
1. Most complex notebook. Optimizer rebuild must capture CBAM params. Unfreezing may conflict with multi-Q ELA statistics.
