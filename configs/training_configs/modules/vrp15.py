#!/usr/bin/env python
# Auto-generated from: vR.P.15 Image Detection and Localisation.ipynb
...
# ============================================================
VERSION = 'vR.P.15'
CHANGE = 'Multi-quality ELA input (Q=75/85/95 as 3 channels)'
SEED = 42
IMAGE_SIZE = 384
BATCH_SIZE = 16
ENCODER = 'resnet34'
...
# This run
print(f'{VERSION:<10} {"Pretrained":<12} {"ResNet-34":<12} {"MQ-ELA 384sq":<14} '
