...
Report Pixel-F1 separately for splicing and copy-move subsets. This reveals whether the model handles both manipulation types. This is not a claim of "subtle tampering detection" capability — it is an analysis of known CASIA categories.
