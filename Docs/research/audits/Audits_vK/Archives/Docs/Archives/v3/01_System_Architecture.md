...
│     Phase 2: + photometric, + optional ELA channel           │
...
│     Phase 2: in_channels=6 if ELA concatenated               │
└──────────────────┬───────────────────────────────────────────┘
                   ▼
┌──────────────────────────────────────────────────────────────┐
│  5. TRAINING                                                  │
...
│     JPEG QF 70/50, Gaussian noise, blur, resize 0.75/0.5x   │
...
│     Log final test metrics, prediction samples, config       │
└──────────────────────────────────────────────────────────────┘
```
...
| Experiment tracking | W&B (optional) | Industry standard; notebook works without it |
...
- **VRAM budget:** ~6 GB with AMP (fits T4's 15 GB)
