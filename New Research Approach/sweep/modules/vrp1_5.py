#!/usr/bin/env python
# Auto-generated from: vR.P.1.5 Image Detection and Localisation.ipynb
...
# ============================================================
VERSION = 'vR.P.1.5'
CHANGE = 'Training speed optimizations: AMP, TF32, parallel data loading, async transfers'
SEED = 42
IMAGE_SIZE = 384
BATCH_SIZE = 16
ENCODER = 'resnet34'
...
EPOCHS = 25
PATIENCE = 7
NUM_WORKERS = 2  # Parallel data loading (was 0 in vR.P.1)
...
print(f'AMP: Enabled | Workers: {NUM_WORKERS}')
print(f'{"="*80}')
