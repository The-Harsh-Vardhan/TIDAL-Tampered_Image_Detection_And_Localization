#!/usr/bin/env python
# Auto-generated from: vR.P.6 Image Detection and Localisation.ipynb
...
# ============================================================
VERSION = 'vR.P.6'
CHANGE = 'EfficientNet-B0 encoder (replace ResNet-34)'
SEED = 42
IMAGE_SIZE = 384
BATCH_SIZE = 16
...
# This run
print(f'{VERSION:<10} {"Pretrained":<12} {"EffNet-B0":<12} {"RGB 384²":<10} '
...
# Save model weights
model_filename = f'{VERSION}_unet_efficientnet_b0_model.pth'
torch.save({
'model_state_dict': model.state_dict(),
'optimizer_state_dict': optimizer.state_dict(),
'scheduler_state_dict': scheduler.state_dict(),
