#!/usr/bin/env python
# Auto-generated from: vR.P.10 Image Detection and Localisation.ipynb
...
PREFETCH_FACTOR = 2      # Explicit prefetching  # Parallel data loading
# --- Attention (NEW for P.10) ---
...
# ── Attention Modules (NEW for P.10) ──────────────────────────────────────────
...
# Step 3: Inject attention into decoder blocks (NEW for P.10)
attn_param_count = 0
...
# Single optimizer â€” all trainable params at same LR (vR.P.10)
