#!/usr/bin/env python
# Auto-generated from: vR.P.13 Image Detection and Localisation.ipynb
...
# ============================================================
VERSION = 'vR.P.13'
CHANGE = 'Combined: CBAM attention + Albumentations augmentation + 50 epochs + Focal+Dice loss'
SEED = 42
IMAGE_SIZE = 384
BATCH_SIZE = 16
ENCODER = 'resnet34'
...
EPOCHS = 50  # Extended from P.3's 25 (from P.7)
PATIENCE = 10  # Extended from P.3's 7 (from P.7)
...
# ============================================================
# 4.1 Build Model (Frozen Body + BN Unfrozen + CBAM)
# ============================================================
...
print(f'{"Version":<10} {"Track":<12} {"Encoder":<12} {"Input":<10} {"Changes":<30} '
f'{"Test Acc":<10} {"Pixel-F1":<10} {"IoU":<8}')
print('-' * 110)

print(f'{"vR.1.1":<10} {"ETASR":<12} {"2-layer CNN":<12} {"ELA 128sq":<10} {"Baseline":<30} '
f'{"88.38%":<10} {"N/A":<10} {"N/A":<8}')

print(f'{"vR.P.3":<10} {"Pretrained":<12} {"ResNet-34":<12} {"ELA 384sq":<10} {"ELA input, frozen+BN":<30} '
f'{"86.79%":<10} {"0.6920":<10} {"0.5291":<8}')

print(f'{"vR.P.7":<10} {"Pretrained":<12} {"ResNet-34":<12} {"ELA 384sq":<10} {"50 epochs":<30} '
f'{"87.37%":<10} {"0.7154":<10} {"0.5569":<8}')

print(f'{"vR.P.10":<10} {"Pretrained":<12} {"ResNet-34":<12} {"ELA 384sq":<10} {"CBAM + Focal+Dice":<30} '
f'{"87.32%":<10} {"0.7277":<10} {"0.5719":<8}')

# This run
print(f'{VERSION:<10} {"Pretrained":<12} {"ResNet-34":<12} {"ELA 384sq":<10} {"CBAM+Aug+50ep+Focal":<30} '
