#!/usr/bin/env python
# Auto-generated from: vR.P.28 Image Detection and Localisation.ipynb
...
VERSION = 'vR.P.28'
CHANGE = 'Cosine Annealing LR Scheduler (T_0=10, T_mult=2, 50 epochs)'
...
print(f'Cosine Annealing: T_0={T_0}, T_mult={T_MULT}, eta_min={LR_MIN}')
...
# ============================================================
# ============================================================
# 5.1 Loss, Optimizer, Scheduler (CHANGED: Cosine Annealing)
# ============================================================
...
# CHANGED: CosineAnnealingWarmRestarts instead of ReduceLROnPlateau
...
print(f'Scheduler: CosineAnnealingWarmRestarts (T_0={T_0}, T_mult={T_MULT}, eta_min={LR_MIN})')
print(f'  Cycle 1: epochs 0-{T_0-1} ({T_0} epochs)')
print(f'  Cycle 2: epochs {T_0}-{T_0 + T_0*T_MULT - 1} ({T_0*T_MULT} epochs)')
print(f'  Cycle 3: epochs {T_0 + T_0*T_MULT}-{EPOCHS-1}')
