# vR.P.30.3 -- Expected Outcomes

## Metric Targets

| Metric | Expected Range | Success Threshold |
|--------|---------------|-------------------|
| Pixel F1 | 0.76-0.78 | > 0.7379 (+0.5pp over P.15) |
...
1. Focal may be redundant when CBAM already provides attention-based focus. P.9 showed only +0.03pp.
