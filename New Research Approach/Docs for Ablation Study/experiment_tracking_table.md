...
| **vR.P.14** | **TTA (4 views)** | **+0.1842** | **+0.1751** | **+0.1109** | **+17.28pp** | TTA hurts at threshold=0.5 |
| **vR.P.15** | **Multi-Q ELA (Q=75/85/95)** | **+0.2783** | **+0.2843** | **+0.1099** | **+17.38pp** | **NEW SERIES BEST — quality diversity > color** |
| **vR.P.18** | **JPEG Robustness (eval-only)** | INVALID | — | — | — | P.3 checkpoint not found |

*P.14 TTA metrics from P.14b (Run-02, complete evaluation). Without TTA: identical to P.3 baseline. P.18 INVALID — P.3 checkpoint not found.*
...
| **vR.P.14b** | **1111** | **13** | 225 | 544 | **1.2%** | 29.3% |
| **vR.P.15** | **1078** | **46** | **190** | **579** | **4.1%** | **24.7%** |

*P.14b = P.14 Run-02 with complete evaluation (fixes Run-01 cell 18 crash). FP Rate 1.2% is best in series.*
...
| Lowest FP Rate | **vR.P.14b** | 1.2% | vR.P.10 | 2.0% |
| Lowest FN Rate | **vR.P.12** | 24.6% | vR.P.15 | 24.7% |
| Param Efficiency | **vR.P.6** | 2.24M trainable | vR.P.3 | 3.17M |

**vR.P.15 dominates** 4 of 11 metrics (Pixel F1, IoU, AUC, Pixel Recall). **vR.P.12** wins 3 (Image Acc, Image F1, FN rate). **vR.P.14b** wins FP rate (1.2%). **vR.P.10** wins Image ROC-AUC. **vR.P.8** wins Pixel Precision. **vR.P.6** wins param efficiency.
...
| NEGATIVE | 1 | vR.P.14/P.14b (-5.32pp TTA) |
| INVALID | 1 | vR.P.18 (checkpoint not found) |
